...
<head>
    ...
    <title>E - Arsip {{ Voyager::setting("title") }}</title>
            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        @if($admin_logo_img == '')
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="{{ asset('images/earsip.png') }}" alt="Logo Icon">
                        @else
                        <img class="img-responsive pull-left logo hidden-xs animated fadeIn" src="{{ Voyager::image($admin_logo_img) }}" alt="Logo Icon">
                        @endif
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('admin_title', 'E - Arsip') }}</h1>
                            <p>{{ Voyager::setting('admin_description', 'Your documents are stored safely, neatly and easily obtained') }}</p>
                        </div>
