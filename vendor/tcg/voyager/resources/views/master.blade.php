...
<head>
    ...
    <title>@yield('page_title',Voyager::setting('admin_title') . " Welcome " . Voyager::setting('admin_description'))</title>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('images/earsip.png') }}" type="image/x-icon">
...
<div id="voyager-loader">
    ...
    @if($admin_loader_img == '')
        <img src="{{ asset('images/earsip.png') }}" alt="Voyager Loader">
    @else
